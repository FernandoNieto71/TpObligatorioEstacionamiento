...
<html lang="en">
  <head>
    ...
    <title>Error de ingreso v4.6</title>
...
<div class="container">
  <div class="jumbotron mt-3">
    ...
    <p class="lead">El usuario no exite. Registrese para poder ingresar a nuestro sistema</p>
    <a class="btn btn-lg btn-primary" href="registro.php" role="button">Ir a Registrarme</a>
  </div>
</div>
